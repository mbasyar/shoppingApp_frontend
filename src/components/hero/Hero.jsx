    ...
    >
      <div className={classes.wrapper}>
        <div className={classes.left}>
          <h2 className={classes.title}>Do you crave delicius food</h2>
          <p className={classes.firstMsg}>
            But going to take <span>food costs time.....</span>
          </p>
          <p className={classes.secondMsg}>
            Why not order <span>pizza</span> or something <br />{" "}
            <span>delicius</span> from our restoraunt
          </p>
          <p className={classes.desc}>
            Our restoraunt always puts the client above. They are our single
            most importtant thing for our business.
          </p>
          <div className={classes.buttons}>
            <button className={classes.buttonOrder}>Order now!</button>
            <button className={classes.buttonSee}>
              <a href="#foods">
                See what's avaible <AiOutlineArrowDown />
              </a>
            </button>
          </div>
        </div>
